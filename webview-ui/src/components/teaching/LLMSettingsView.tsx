    ...
    <div style={styles.container}>
      ...
      <p style={styles.subtitle}>
        ...
        <span style={styles.warning}>
          ⚠ 与 Cline 主对话模型解耦 —— 此处的配置仅用于教学功能，不会影响 AI 编程对话。
        </span>
      </p>
      ...
      <Section title="模型选择">
        ...
        <p style={styles.hint}>
          选择预置模型后，baseUrl 会自动填充。也可选"自定义"手动填 baseUrl。
        </p>
      </Section>
      ...
      <Section title="API Key">
        ...
        />
        <p style={styles.hint}>
          🔒 API Key 仅写入本地 <code>~/.cline/teaching-llm.env</code> 与后端{" "}
          <code>teaching-server/.env</code>，不会上传至任何远程。
        </p>
      </Section>
      ...
      <div style={{ marginTop: 16 }}>
        ...
        {testStatus !== "idle" && (
          <span
            style={{
              marginLeft: 12,
              color: testStatus === "success" ? "var(--vscode-terminal-ansiGreen)" : "var(--vscode-errorForeground)",
              fontSize: 13,
            }}
          >
      ...
      <Section title="⚙ 高级选项">
        ...
        <div style={styles.toggleHint}>
          <p>
            开启后，跨周复杂问题（如"对比第 3 周和第 7 周的概念"）将由 LLM
            自主调用 grep_wiki / read_chunk 工具检索 Wiki。
          </p>
