...
const AssignmentHeader: FC = () => {
	...
	return (
		<div style={styles.container}>
			...
			{/* 第一行：获取任务按钮 */}
			<button disabled={fetching} onClick={onFetch} style={{ ...styles.button, ...styles.primaryButton, marginBottom: 10 }}>
				{fetching ? "⏳ 获取中..." : "⬇ 获取任务"}
			</button>
			{fetchStatus !== "idle" && (
				<div
			...
			<div style={{ marginTop: 10, marginBottom: 10 }}>
				...
				<select onChange={(e) => onWeekChange(Number(e.target.value))} style={styles.select} value={currentWeek}>
			...
			{/* 第三行：服务器设置按钮 */}
			<button onClick={openServerModal} style={{ ...styles.button, ...styles.secondaryButton }}>
				⚙ 服务器设置
			</button>
			<div style={styles.hint}>
